...
export class AddThesisProjectComponent {
  ...
  ngOnInit(): void {
    ...
    const project_or_thesis_error_control =
      this.publications_form.get('project_or_thesis');
    ...
    const publication_link_error_control =
      this.publications_form.get('publication_link');
    ...
    const date_of_publication_error_control = this.publications_form.get(
      'date_of_publication',
    );
    ...
    const publication_description_error_control = this.publications_form.get(
      'publication_description',
    );
