...
import {
  faBuildingColumns, faBuildingUser, faCalendarDays,
  faCircleCheck,
  faEnvelope, faFileSignature,
  faImage, faLink,
  faPenToSquare, faSquarePollHorizontal,
  faTrash, faUserGraduate,
  faUserTag,
...
export class StudentMentorAboutComponent {
  ...
  getControl_of_update_educational_qualification_form(name:any): AbstractControl | null{
    return this.update_educational_qualification_form.get(name);
  }
  //oninit function
  ngOnInit(): void {
    // for update educational qualification
    const programme_name_error_control = this.update_educational_qualification_form.get('programme_name');
    ...
    const institution_name_error_control = this.update_educational_qualification_form.get('institution_name');
    ...
    const result_error_control = this.update_educational_qualification_form.get('result');
    result_error_control?.valueChanges.subscribe(institution_name=>{
      this.validate_result(result_error_control as FormControl);
    })
    const department_error_control = this.update_educational_qualification_form.get('department');
    ...
    const passing_year_error_control = this.update_educational_qualification_form.get('passing_year');
    ...
    const project_or_thesis_error_control = this.update_publications_form.get('project_or_thesis');
    ...
    const publication_link_error_control = this.update_publications_form.get('publication_link');
    ...
    const date_of_publication_error_control = this.update_publications_form.get('date_of_publication');
    ...
    const publication_description_error_control = this.update_publications_form.get('publication_description');
  ...
  update_educational_qualification(){
    console.log(this.update_educational_qualification_form.value,this.update_educational_qualification_form.invalid);
  ...
  update_publication_form(){
    console.log(this.update_publications_form.value,this.update_publications_form.invalid);
